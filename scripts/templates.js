function pokecardFront(allPokeIndex) {
  return `<div id="card${allPokeIndex}" onclick="openOverlay(${allPokeIndex})"class="pokecard_front ${allPokemon[allPokeIndex].types[0].type.name}">
            <div class="card_header">
              <h2 id="cardName${allPokeIndex}">${allPokemon[allPokeIndex].name}</h2>
...
function inputTemplate(){
  return `<input placeholder="search your Pokémon" oninput="searchPokemon()" id="searchPokemon" type="text"/>`
}